$(function() {
	...
	// 根据主键获取授权信息的URL
	var infoUrl = '/o2oo/shopadmin/getshopauthmapbyid?shopAuthId=' + shopAuthId;
	// 修改授权信息的URL
	var shopAuthPostUrl = '/o2oo/shopadmin/modifyshopauthmap';

	if (shopAuthId) {
		getInfo(shopAuthId);
	} else {
		$.toast('用户不存在！');
		window.location.href = '/o2oo/shopadmin/shopmanage';
	}
